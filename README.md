...
```text
![tool_call_log.jsonl 中 cache_hit 字段截图](docs/images/advanced/tool_call_log.jsonl 中 cache_hit 字段截图.png)
![tool_cache.json 截图](docs/images/advanced/tool_cache.json 截图.png)
